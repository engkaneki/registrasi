...
} else if ($_SESSION['role'] == "pdip") {
    header("location:../pdip/");
} else if ($_SESSION['role'] == "verif") {
    header("location:../cek/");
}
                ...
                <ul class="sidebar-nav">
                    ...
                    <li class="sidebar-item">
                        <a href="#dashboards" data-toggle="collapse" class="sidebar-link">
                            ...
                            <span class="align-middle">Loket</span>
                        </a>
                        <ul id="dashboards" class="sidebar-dropdown list-unstyled collapse show" data-parent="#sidebar">
                            <li class="sidebar-item">
                                <a href="./" class="sidebar-link">TTE Loket</a>
                            </li>
                            <li class="sidebar-item">
                                <a href="pending.php" class="sidebar-link">Berkas Pending</a>
                            </li>
                            <li class="sidebar-item">
                                <a href="selesai.php" class="sidebar-link">Berkas Selesai</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="sidebar-item">
                        <a href="#desa" data-toggle="collapse" class="sidebar-link">
                            <i class="align-middle mr-2 fas fa-fw fa-home"></i>
                            <span class="align-middle">Hadir di Desa</span>
                        </a>
                        <ul id="desa" class="sidebar-dropdown list-unstyled collapse" data-parent="#sidebar">
                            <li class="sidebar-item">
                                <a href="kk.php" class="sidebar-link">KARTU KELUARGA</a>
                            </li>
                            <li class="sidebar-item">
                                <a href="akta_lahir.php" class="sidebar-link">AKTA KELAHIRAN</a>
                            </li>
                            <li class="sidebar-item">
                                <a href="akta_mati.php" class="sidebar-link">AKTA KEMATIAN</a>
                            </li>
                            <li class="sidebar-item">
                                <a href="surat_pindah.php" class="sidebar-link">SURAT PINDAH</a>
                            </li>
                        </ul>
                    </li>
                    <li class="sidebar-item">
                        <a href="#dokter" data-toggle="collapse" class="sidebar-link">
                            <i class="align-middle mr-2 fas fa-fw fa-home"></i>
                            <span class="align-middle">Dokter KK</span>
                        </a>
                        <ul id="dokter" class="sidebar-dropdown list-unstyled collapse" data-parent="#sidebar">
                            <li class="sidebar-item">
                                <a href="dokter.php" class="sidebar-link">Berkas Dokter KK</a>
                            </li>
                        </ul>
                    </li>
                    <li class="sidebar-item">
                        <a href="#markus" data-toggle="collapse" class="sidebar-link">
                            <i class="align-middle mr-2 fas fa-fw fa-home"></i>
                            <span class="align-middle">Markus</span>
                        </a>
                        <ul id="markus" class="sidebar-dropdown list-unstyled collapse" data-parent="#sidebar">
                            <li class="sidebar-item">
                                <a href="markus.php" class="sidebar-link">Berkas Markus</a>
                            </li>
                        </ul>
                    </li>
                    <!-- Berkas Menyusul
                    <li class="sidebar-item">
                        <a href="#dashboards" data-toggle="collapse" class="sidebar-link">
                            <i class="align-middle mr-2 fas fa-fw fa-home"></i>
                            <span class="align-middle">Moling</span>
                        </a>
                        <ul id="dashboards" class="sidebar-dropdown list-unstyled collapse" data-parent="#sidebar">
                            ...
                            <li class="sidebar-item">
                                <a href="pending.php" class="sidebar-link">Dokumen Pending</a>
                            </li>
                        </ul>
                    </li>
                    Berkas Menyusul-->
