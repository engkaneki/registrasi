                ...
                <ul class="sidebar-nav">
                    ...
                    <li class="sidebar-item">
                        ...
                        <ul id="dashboards" class="sidebar-dropdown list-unstyled collapse" data-parent="#sidebar">
                            ...
                            <li class="sidebar-item">
                                <a href="selesai.php" class="sidebar-link">Dokumen Selesai</a>
                            </li>
                            <li class="sidebar-item">
                                <a href="ditolak.php" class="sidebar-link">Dokumen Ditolak</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="sidebar-item">
                        ...
                        <ul id="users" class="sidebar-dropdown list-unstyled collapse" data-parent="#sidebar">
                            <li class="sidebar-item">
                                <a href="users.php" class="sidebar-link">Daftar Pengguna</a>
                            </li>
                        </ul>
                    </li>

                    <li class="sidebar-item">
                        <a href="#traffic" class="sidebar-link" data-toggle="collapse">
                            <i class="align-middle mr-2 fas fa-fw fa-user-secret"></i>
                            <span class="align-middle">Traffict Loket</span>
                        </a>
                        <ul class="sidebar-dropdown list-unstyled collapse" id="traffic" data-parent="#sidebar">
                            <li class="sidebar-item">
                                <a href="traffic.php" class="sidebar-link">Loket</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="sidebar-item">
                        <a href="#laporan" class="sidebar-link" data-toggle="collapse">
                            <i class="align-middle mr-2 fas fa-fw fa-print"></i>
